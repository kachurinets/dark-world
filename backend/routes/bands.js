...
router.get("genre", (req, res, next) => {
    let genres = ["Ambient", "Angry Metal", "Atmospheric Black", "Avant-garde Metal", "Black Industrial", "Black Metal", "Brutal Death", "Crust", "Cybergrind", "Dark Ambient", "Dark Electro", "Dark Folk", "Dark Metal", "Darkwave", "Death Metal", "Deathcore", "Depressive Black", "Doom Metal", "Doom/Death Metal", "Drone Doom", "EBM", "Epic Metal", "Ethereal", "Extreme Metal", "Folk Metal", "Folk Rock", "Funeral Doom", "Goregrind", "Goth Industrial", "Gothic Doom/Dark", "Gothic Metal", "Gothic Rock", "Grindcore", "Heavy Metal", "Horror Metal", "Industrial", "Instrumental", "Martial Industrial", "Mathcore", "Medieval", "Melodic Black", "Melodic Death", "Melodic Metal", "Neo-Classic", "Neo-Classical Metal", "Noise", "NS Black Metal", "Occult Rock", "Pagan Metal", "Porngrind", "Post-Metal", "Power Metal", "Progressive Black", "Progressive Death", "Progressive Metal", "Raw Black Metal", "Shoegaze", "Sludge Metal", "Speed Metal", "Stoner Metal", "Sympho Black", "Symphonic Metal", "Technical Black", "Technical Death", "Thrash Metal", "True Black Metal", "Vampiric Metal", "Viking Metal"];
